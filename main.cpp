#include "TXLib.h"
  ...
  void DrawMan(int x)
  {
    ...
    txCircle(x,415,25); //Голова
    txLine(x,440,x,520); //Тело
    txLine(x,450,x-30,485); //Левая рука
    txLine(x,450,x+30,485); //Правая рука
    txLine(x,520,x-30,547); //Левая нога
    txLine(x,520,x+30,547); //Правая нога
  ...
  void DrawWindow()
  {
   ...
   txRectangle(201,361,255,420); //Левый верхний квадрат
   txRectangle(255,420,309,361); //Правый верхний квадрат
   txRectangle(201,469,255,420); //Левый нижний квадрат
   txRectangle(255,420,309,469); //Правый нижний квадрат
